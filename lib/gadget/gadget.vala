	...
	private class Server : BaseController {
		...
		private class Client : Object, HostSession {
			...
			private void on_session_closed (BaseAgentSession base_session) {
				ClientSession session = (ClientSession) base_session;
		...
		private class ClientSession : BaseAgentSession {
			...
			public ClientSession (ProcessInvader invader, AgentSessionId id) {
