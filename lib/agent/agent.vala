namespace Frida.Agent {
	...
	private class Runner : Object, ProcessInvader, AgentSessionProvider, ExitHandler, ForkHandler, SpawnHandler {
		...
		private void on_client_closed (BaseAgentSession session) {
			AgentClient client = (AgentClient) session;
	...
	private class AgentClient : BaseAgentSession {
		...
		public AgentClient (ProcessInvader invader, AgentSessionId id) {
